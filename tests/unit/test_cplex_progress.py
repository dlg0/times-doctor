...
class TestParseCplexLine:
    ...
    def test_parse_barrier_line(self):
        line = (
            "Barrier iteration 10: mu = 1.23e-04, primal infeas = 2.34e-02, dual infeas = 3.45e-03"
        )
...
class TestFormatProgressLine:
    ...
    def test_format_crossover_no_percentage(self):
        ...
        parsed = {"phase": "crossover", "iteration": "25", "mu": 9.99e-09}
    ...
    def test_format_without_tracker(self):
        parsed = {"phase": "barrier", "iteration": "10", "mu": 1e-4}
...
class TestScanLogForProgress:
    ...
    def test_scan_no_cplex_output(self):
        lines = ["GAMS starting...", "Compiling model...", "Model compiled successfully"]
